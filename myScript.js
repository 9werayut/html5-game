...
function drawBirds() {
    ...
    while (birds != undefined && i < birds.length) {
        ctx.drawImage(birdImage, 0, birds[i + 2] * birdHeight, birdWidth, birdHeight, birds[i], birds[i + 1], birdWidth, birdHeight);
        i = i + 3;
    }
}
...
function drawCopter(){
    ctx.drawImage(copterImage, copterWidth * frameIndex, 0, copterWidth, copterHeight,
                    copterX, copterY, copterWidth, copterHeight);
}

//coins
var coinWidth = 31;
var coinHeight = 46;
var coinFrameIndex = 0;

var coins = [];   //0=x, 1=y, 2=frameInd
...
function drawCoin(){
    ...
    while(coins != undefined && i < coins.length){
        ctx.drawImage(coin, 0, coins[i +2] * coinHeight, coinWidth,
        coinHeight, coins[i], coins[i + 1], coinWidth, coinHeight);
